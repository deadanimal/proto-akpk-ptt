...
@Component({
  selector: 'app-scheduling-task',
  templateUrl: './scheduling-task.component.html',
  styleUrls: ['./scheduling-task.component.scss']
})
export class SchedulingTaskComponent implements OnInit, OnDestroy {
